...
function CovidCard({ title, span }) {
  return (
    <Link
      to="/covid-travel"
      className="mian__container__covid__overlay__content__card"
      onClick={() => {
        window.scrollTo({
          top: 0,
          behavior: "smooth",
        ...
        <div className="main__container__book__overlay">
          <div className="main__container__book__overlay__content">
            <div className="main__container__book__overlay__content__heading">
              Book Your Next Trip in<span> 3 Steps</span>
            </div>
        ...
        <div className="mian__container__covid__overlay">
          <div className="mian__container__covid__overlay__content">
            <div className="mian__container__covid__heading">
              Book Your COVID-19 PCR Test <span> With Us</span>
            </div>
          ...
          <div className="main__container__journel__overlay__content">
            ...
            <div className="main__container__journel__overlay__content__wrapper">
              <div className="main__container__journel__overlay__content__wrapper__left">
                ...
                <button style={{ width: 410 }} className="primary__btn__black">
